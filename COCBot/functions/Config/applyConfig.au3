...
If $ichkswdonate = 1 Then
		GUICtrlSetState($chkSwitchD, $GUI_CHECKED)
	Else
		GUICtrlSetState($chkSwitchD, $GUI_UNCHECKED)
	EndIf
	If $chkATH = 1 Then
	...
	If $OptSpellNone= 1 then
		GUICtrlSetState($chkSpellNone, $GUI_CHECKED)
	Else
...
;~ 	EndIf
    ...
    EndIf
	    _GUICtrlComboBox_SetCurSel($cmbgtfo,$gtfocount)
