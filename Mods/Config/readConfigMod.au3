...
$BottomTHType = IniRead($config, "advanced", "BottomTHType", "2")
...
$AttackTHType = IniRead($config, "advanced", "AttackTHType", "7")
...
$useFFBarchST  = IniRead($config, "advanced", "ChkSTFFBarch", "0")

;Use Spells Th
$ichkUseSpellsTH = IniRead($config, "advanced", "chkUseSpellsTH", "0")
$icmbInsideCol = IniRead($config, "advanced", "cmbInsideCol", "0")
